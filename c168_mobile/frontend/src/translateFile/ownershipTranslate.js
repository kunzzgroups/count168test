...
export const OWNERSHIP_I18N = {
  ...
  zh: {
    ...DASHBOARD_I18N.zh,
    pageTitle: "Ownership",
    pageSubtitle: "公司归属与分组收益。",
    ownershipDescription: "设置公司与分组的归属比例。",
    backToMore: "返回更多",
    independent: "独立公司",
    tapToEdit: "点按编辑",
    expirationDate: "到期日",
    accessDenied: "你没有 Ownership 页面权限。",
...
export function ownershipText(lang) {
  return OWNERSHIP_I18N[lang === "zh" ? "zh" : "en"];
}
