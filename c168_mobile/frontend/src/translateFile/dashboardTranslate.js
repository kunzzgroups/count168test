export const DASHBOARD_I18N = {
  en: {
    ...
    panelEyebrowCurrency: "Net by currency",
    panelEyebrowEarning: "Your earnings",
    panelEyebrowCompany: "Net by company",
    rate: "Rate",
  ...
  zh: {
    ...
    currencies: "币种",
    panelEyebrowCurrency: "按币种净利",
    panelEyebrowEarning: "你的收益",
    panelEyebrowCompany: "按公司净利",
    rate: "汇率",
    shareOfTotal: "占比",
