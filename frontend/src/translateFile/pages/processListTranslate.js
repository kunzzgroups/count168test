...
export const PROCESS_LIST_I18N = {
  en: {
    ...
    enableSaveDraft: "Enable Save Draft",
    enableSaveDraftHelp: "Data Capture keeps an in-progress draft of this process's table so it can be restored later.",
    dayMonday: "MON",
    dayTuesday: "TUE",
    dayWednesday: "WED",
    dayThursday: "THU",
  ...
  zh: {
    ...
    enableSaveDraftHelp: "开启后，Data Capture 会保留这个 process 尚未提交的表格草稿，方便之后继续填写。",
    dayMonday: "周一",
    dayTuesday: "周二",
    dayWednesday: "周三",
    dayThursday: "周四",
